...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    try {
      ...
      let dataOld = await AsyncStorage.getItem(dataKey);      
      let savedData = dataOld ? JSON.parse(dataOld) : [];
      savedData = [...savedData, newLoginData];
      // console.log(savedData);
      await AsyncStorage.setItem(dataKey, JSON.stringify(savedData));
      navigate('Home');
    }
    catch (error) {
      console.log(error);
